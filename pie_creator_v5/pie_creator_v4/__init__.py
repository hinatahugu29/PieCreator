bl_info = {
    ...
    "version": (0, 4, 0),
    "blender": (5, 0, 0),
    "location": "Preferences > Addons > PieCreator V4",
    "description": "Hybrid Nesting Menu Editor (V4) - Copy/Move Support",
    "category": "Interface",
}
...
def draw_context_menu(self, context):
    try:
        ...
        if is_prop:
            ...
            if target_op and "pie_creator" not in getattr(target_op, 'bl_idname', ''):
